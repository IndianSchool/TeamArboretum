...
import CombineFileInputFormat.CFInputFormat;
import CombineFileInputFormat.FileLineWritable;


public class CombineFileInputDriver extends Configured implements Tool{
  ...
  public static void main(String[] args) throws Exception {
    System.exit(ToolRunner.run(new Configuration(), new CombineFileInputDriver (), args));
  }
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(CombineFileInputDriver.class);
